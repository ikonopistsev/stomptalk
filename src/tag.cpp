...
//     case send::text_hash:
//         return send::text;
//     case abort::text_hash:
//         return abort::text;
//     case begin::text_hash:
//         return begin::text;
//     case error::text_hash:
//         return error::text;
//     case stomp::text_hash:
//         return stomp::text;
//     case commit::text_hash:
//         return commit::text;
//     case message::text_hash:
//         return message::text;
//     case receipt::text_hash:
//         return receipt::text;
//     case connect::text_hash:
//         return connect::text;
//     case connected::text_hash:
//         return connected::text;
//     case subscribe::text_hash:
//         return subscribe::text;
//     case disconnect::text_hash:
//         return disconnect::text;
//     case unsubscribe::text_hash:
//         return unsubscribe::text;
//     }
//     return "unknown"sv;
...
// size_t stomptalk_eval_method(size_t hash)
// {
//     using namespace stomptalk::method;    
//     switch (hash)
//     {
//     case tag::ack::text_hash:
//         return tag::ack::num;
//     case tag::nack::text_hash:
//         return tag::nack::num;
//     case tag::send::text_hash:
//         return tag::send::num;
//     case tag::abort::text_hash:
//         return tag::abort::num;
//     case tag::begin::text_hash:
//         return tag::begin::num;
//     case tag::error::text_hash:
//         return tag::error::num;
//     case tag::stomp::text_hash:
//         return tag::stomp::num;
//     case tag::commit::text_hash:
//         return tag::commit::num;
//     case tag::message::text_hash:
//         return tag::message::num;
//     case tag::receipt::text_hash:
//         return tag::receipt::num;
//     case tag::connect::text_hash:
//         return tag::connect::num;
//     case tag::connected::text_hash:
//         return tag::connected::num;
//     case tag::subscribe::text_hash:
//         return tag::subscribe::num;
//     case tag::disconnect::text_hash:
//         return tag::disconnect::num;
//     case tag::unsubscribe::text_hash:
//         return tag::unsubscribe::num;
//     }
//     return num_id::unknown;
// }
...
// size_t stomptalk_eval_header_hash(size_t hash);
